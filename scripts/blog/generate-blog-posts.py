...
def generate_blog_content(
    ...
    try:
        response = client.chat.completions.create(
            ...
            max_completion_tokens=4000,  # Increased to allow for reasoning tokens + content tokens (gpt-5-nano uses max_completion_tokens instead of max_tokens)
            reasoning_effort="minimal",  # Set to minimal to prioritize content generation over reasoning
            verbosity="high"  # Set to high to get detailed, longer responses for blog content
        )
